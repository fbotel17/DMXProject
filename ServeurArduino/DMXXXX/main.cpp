...
class ManageArduino : public QObject
{
    Q_OBJECT

public:
    explicit ManageArduino(QObject *parent = nullptr) : QObject(parent) {}
    ...
    void start()
    {
        ...
        QObject::connect(&serial, &QSerialPort::readyRead, this, &ManageArduino::readData);
    }
